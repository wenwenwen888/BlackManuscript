...
【关键：栏位方向必须正确，赞叹对方算失败】
- side="left"：必须是在嘲讽/批评**中国**。若外媒在赞美中国（如"中国电动车杀疯了碾压欧洲"）或主要嘲讽欧美——**pass=false**。
- side="right"：必须是在嘲讽/批评**海外**。若中媒在赞美中国成就、或主要批评中国自己——**pass=false**。
- 标题党式"借夸中国骂外国"若核心锋芒指向外国、且来源是中媒，可算 right；但绝不能放进 left。
