...
TOPIC_RULES: list[tuple[str, list[tuple[str, int]]]] = [
    ("股票", [
        ("A股", 4), ("港股", 4), ("美股", 4), ("股市", 4), ("股价", 3),
        ("涨停", 4), ("跌停", 4), ("牛市", 3), ("熊市", 3), ("股民", 3),
        ("证监会", 3), ("IPO", 3), ("纳斯达克", 4), ("道琼斯", 4), ("标普", 3),
        ("沪指", 4), ("深成指", 3), ("创业板", 3), ("科创板", 3),
        ("华尔街", 3), ("做空", 3), ("量化", 2), ("stock", 3), ("shares", 2),
        ("Wall Street", 3), ("Nasdaq", 3), ("Dow Jones", 3),
    ]),
    ("电影", [
